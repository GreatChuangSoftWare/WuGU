...
Framework.UI.FormModal = function (params) {
    ...
    if (!Framework.Tool.isUndefined(params.confirmCloseText)) {//保存并关闭
...
alert("sdd");
//编辑窗体
Framework.Tool.FwRowPopup = function (obj) {
    //var tableselect = currObj.data("tableselect");//Table选择器
    //data-btnbehavior='{0}' data-fun='{1}' data-pkname='{2}'  data-pkval='{3}' data-modularname='{4}' data-popupwidth='{5}'
    var btnbehavior = obj.data("btnbehavior");
    var fun = obj.data("fun");
    var pkname = obj.data("pkname");
    var pkval = obj.data("pkval");
    var modularname = obj.data("modularname");
    var btnnamecn=obj.data("btnnamecn");
    if (Framework.Tool.isUndefined(modularname))
        modularname = "";

    var popupwidth = obj.data("popupwidth");
