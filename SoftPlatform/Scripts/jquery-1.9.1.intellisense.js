intellisense.annotate(jQuery, {
  ...
  'isEmptyObject': function() {
    /// <signature>
    ///   <summary>Check to see if an object is empty (contains no eNumberable properties).</summary>
