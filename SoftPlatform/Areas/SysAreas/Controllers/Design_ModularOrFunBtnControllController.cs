...
{
    public class Design_ModularOrFunBtnControllController : BaseController
    {
        public Design_ModularOrFunBtnControllController()
        {
        }
        ...
        {
            var resp = domain.Design_ModularOrFunBtnControll_GetByModularOrFunBtnID();
            //resp.FunNameEn = "Edit";
            //resp.FunNameCn = "编辑";
        ...
        {
            //return null;
            var resp = domain.Design_ModularOrFunBtnControll_EditListSave();
        ...
        {
            var resp = domain.Design_ModularOrFunBtnControll_Rows();
