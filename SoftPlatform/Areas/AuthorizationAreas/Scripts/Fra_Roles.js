...
(function (Fra_Roless) {
    ...
    Fra_Roless.Init = function () {
        ...
        //$('#IndexPFra_Roles #toolbarbtn .btn-Add').click(function (e) {
        //    Framework.Ajax.GetView({}, 'Fra_Roles/Edit', function (result) {
        //        var params = {
        //            title: '添加角色信息',
        //            width: 600,
        //            message: result,
        ...
        //                    Framework.Ajax.PostJson(data, 'Fra_Roles/Edit', function (results) {
        //                        //错误处理
        ...
        //};
        ///////////////////////////角色编辑--保存/////////////////////////
        //$(document).delegate('#editPFra_RolesHModular .btn-Save', 'click', function (e) {
        //    var btn = $(this);

        //    var obj = $("#editPFra_Roles");
        //    var data = {};
        ...
        //                var fieldname1 = "Item.Fra_RolesPremCodes[" + k + "].DataRight";
        //                data[fieldname1] = DataRightVal;
        //                var fieldnamePremCodeID = "Item.Fra_RolesPremCodes[" + k + "].Sys_PremCodeID";
        //                data[fieldnamePremCodeID] = Sys_PremCodeID;
        //                k++;
        //            }
        //        });
        //        //进行保存
        //        var url = "Fra_Roles/Edit";
        //        if (data["Item.Fra_RolesID"] == "")
        //        {
        //            url = "Fra_Roles/Add";
        //        }
        ...
        //            var data = results.Data;
        //            alert("保存成功");
        //            window.location.href = Framework.Page.BaseURL + "AuthorizationAreas/Fra_Roles/Index";
        //        })
        //    }
        //});
