...
namespace Framework.Web.Mvc.ADORepository
{
    public class SafeDataReader : IDataReader
    {
        ...
        {
            return GetNullInt32(_dataReader.GetOrdinal(name));
        }
        ...
        public virtual int? GetNullInt32(int i)
        {
            if (_dataReader.IsDBNull(i))
                return null;
            else
        ...
        /// </remarks>
        /// <param name="name">Name of the column containing the value.</param>
        public DateTime? GetSmartDate(string name)
        {
        ...
        /// </remarks>
        /// <param name="i">Ordinal column position of the value.</param>
        public virtual DateTime? GetSmartDate(int i)
        {
            if (_dataReader.IsDBNull(i))
        ...
        public bool? GetNullBoolean(string name)
        {
            return GetNullBoolean(_dataReader.GetOrdinal(name));
        }
        ...
        public virtual bool? GetNullBoolean(int i)
        {
            if (_dataReader.IsDBNull(i))
                return null;
            else
        ...
        public virtual DateTime? GetNullDateTime(string name)
        {
            return GetNullDateTime(_dataReader.GetOrdinal(name));
        }
        ...
        public virtual DateTime? GetNullDateTime(int i)
        {
            if (_dataReader.IsDBNull(i))
        ...
        {
            return GetNullDecimal(_dataReader.GetOrdinal(name));
        }
        ...
        public virtual decimal? GetNullDecimal(int i)
        {
            if (_dataReader.IsDBNull(i))
                return null;
            else
        ...
        {
            return GetNullFloat(_dataReader.GetOrdinal(name));
        }
        ...
        public virtual float? GetNullFloat(int i)
        {
            if (_dataReader.IsDBNull(i))
                return null;
            else
        ...
        public short? GetNullInt16(string name)
        {
            return GetNullInt16(_dataReader.GetOrdinal(name));
        }
        ...
        public virtual short? GetNullInt16(int i)
        {
            if (_dataReader.IsDBNull(i))
                return null;
            else
        ...
        {
            return GetNullInt64(_dataReader.GetOrdinal(name));
        }

        public virtual Int64? GetNullInt64(int i)
        {
            if (_dataReader.IsDBNull(i))
                return null;
            else
